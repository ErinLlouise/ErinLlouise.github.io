      ...
      <ul class="timeline">
        <li>
          <div class="direction-r">
            <div class="flag-wrapper">
              <span class="flag">Accenture Interactive</span>
        ...
        <li>
          <div class="direction-l">
            <div class="flag-wrapper">
              <span class="flag">Enspiral Dev Academy</span>
        ...
        <li>
          <div class="direction-r">
            <div class="flag-wrapper">
              <span class="flag">Bachelors Degree</span>
        ...
        <div class="direction-l">
          <div class="flag-wrapper">
            <span class="flag">Mecca Brands</span>
